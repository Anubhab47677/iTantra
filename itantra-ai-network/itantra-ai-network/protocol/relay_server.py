...
ITANTRA_ROOT = os.path.join(os.path.dirname(PROJECT_ROOT), "iTantra")
if ITANTRA_ROOT not in sys.path:
    sys.path.append(ITANTRA_ROOT)
...
def get_network_stats():
    return {
        ...
        "huggingface_datasets": ["google/fleurs", "facebook/mms-tts", "ai4bharat/indic-speech"],
